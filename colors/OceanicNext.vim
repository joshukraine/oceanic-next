...
call <sid>hi('Folded',                     s:base03, s:custom00, s:italic,  '')
...
call <sid>hi('VertSplit',                  s:base00, s:custom01, '',        '')
call <sid>hi('CursorLine',                 '',       s:custom00, 'NONE',    '')
call <sid>hi('ColorColumn',                '',       s:custom00, 'NONE',    '')
call <sid>hi('CursorColumn',               '',       s:custom00, 'NONE',    '')
call <sid>hi('CursorLineNR',               s:base00, s:custom00, 'NONE',    '')
call <sid>hi('CursorLineNr',               s:base03, s:custom00, 'NONE',    '')
...
call <sid>hi('Include',                    s:base0D, '',       s:italic,    '')
